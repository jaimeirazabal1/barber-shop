...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('.input-timepicker').timepicker({minuteStep: 30,showSeconds: false,showMeridian: true});
        $('.input-timepickermin').timepicker({minuteStep: 1,showSeconds: false,showMeridian: true});
