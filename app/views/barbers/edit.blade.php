        ...
        <div class="col-md-8">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2>Editar información del Barbero</h2>
                ...
                <!-- Form Content -->
                {{ Form::model($barber, array('method' => 'PATCH', 'route' => array('barbers.update', $company, $barber->id), 'class' => 'form-horizontal form-bordered'))  }}
