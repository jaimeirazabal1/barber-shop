    ...
    <div class="block animation-fadeInQuickInv">
        ...
        <div class="block-title">
            <div class="block-options pull-right">
                <a href="{{ route('sessions.password-recovery', $company) }}" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="¿Olvidaste tu contraseña?"><i class="fa fa-exclamation-circle"></i></a>
        ...
        <!-- Login Form -->
        {{ Form::open(array('id' => 'form-login', 'method' => 'POST', 'class' => 'form-horizontal', 'route' => ['sessions.store', $company])) }}
